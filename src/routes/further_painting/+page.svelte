<script lang="ts">
    ...
    async function submitFeedback() {
        ...
        // Set the modified image as the control image
        ...
        // Additionally, add the modified image to history as a separate entry
            ...
            {#each history.slice(0, history.length - 1) as item, index}
                <div class="history-item">
                    ...
                    <div class="prompt-section">
                        ...
                        <p class="type">Type: {item.type === 'generated' ? 'AI Generated' : 'User Modified'}</p>
                    </div>
                </div>
            {/each}
        </div>
